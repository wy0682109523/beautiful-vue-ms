            ...
            >
                ...
                <el-table-column label="数量" align="center">
                    <template slot-scope="scope">
                        <el-input-number v-model="scope.row.quantity" @change="handleChange(scope.$index, scope.row)"
...
<script>
    import { deleteInventory, deleteInventoryList, updateInventory } from '../../api/InventoryApi';
    import { getCartList, updateCart } from '../../api/CartApi';
    ...
    export default {
        ...
        methods: {
            ...
            handleChange(index, row) {
                ...
                this.updateCartParam = {
                    cartId: row.cartId,
                    quantity: row.quantity
                };

                updateCart(this.updateCartParam).then(() => {
